...
def main():
    ...
    training_generator = DataGenerator(
        X_train_full[train_indices], y_train_full[train_indices], BATCH_SIZE
    )
    validation_generator = DataGenerator(
        X_train_full[val_indices], y_train_full[val_indices], BATCH_SIZE
    )
    ...
    callbacks = [
        keras.callbacks.ModelCheckpoint(
            MODEL_V2_PATH, save_best_only=True, monitor="val_loss"
        ),
